...
fun PackageSelectionBottomSheet(
    ...
    SuperBottomSheet(
        ...
        show = show,
        title = stringResource(R.string.add_package_style),
                ...
                AppList(
                    ...
                    onSelection = { packageName, selected ->
                        ...
                        if (context is Activity) {
                            context.window.decorView.performHapticFeedback(HapticFeedbackConstants.CONTEXT_CLICK)

                            //context.window.decorView.performHapticFeedback(if (selected) HapticFeedbackConstants.TOGGLE_ON else HapticFeedbackConstants.TOGGLE_OFF)
                        }
                    }
                )
            }
