...
package com.makino.lyricon.model.lyric.provider.v1
...
class V1(
     ...
     */
    private fun <T : ILyricTiming> List<T>.getOverlappingRange(
        position: Long,
        matchIdx: Int
    ): List<T> {
        var start = matchIdx
